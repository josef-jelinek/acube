...
public final class PruneTestFull {
  ...
  public void sizes_of_tables_A() {
    final Transform transform = new Transform(Turn.valueSet, new ConsoleReporter());
  ...
  public void sizes_of_tables_B() {
    final TransformB transform = new TransformB(Corner.valueSet, Edge.valueSet, Turn.valueSet, new ConsoleReporter());
